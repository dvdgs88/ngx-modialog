import { ModalOpenContext, ModalOpenContextBuilder, FluentAssignMethod } from '../../../public_api';
export type VEXBuiltInThemes = 'default' | 'os' | 'plain' | 'wireframe' | 'flat-attack' | 'top' | 'bottom-right-corner';
